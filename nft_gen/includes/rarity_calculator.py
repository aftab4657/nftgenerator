...
class RarityCalculator:
    ...
    percentages = []
    rarities = []
    def __init__(self, nfts,colors, rarities, percentages, dir_path):
        self.colors = colors
    ...
    def PlotPercentages(self, percentagesList, rarityList, nfts):
        ...
        for i in range (len(nfts.attributes)):
            ...
            plt.savefig(self.dir_path + '/output/rarity/plots/' + nfts.attributes[i]+'.png')
            print('Done.')
    ...
    def CreateRaritiesJsonReadable(self, nfts, rarityList, percentagesList, stockList):
        ...
        with open(self.dir_path + '/output/rarity/raritiesToReactMap.json', 'w') as jsonFile:
    ...
    def CreateNFTRanking(self, nfts, percentageList, stockList):
        ...
        with open(self.dir_path + '/output/rarity/nftsRanking.json', 'w') as jsonFile:
