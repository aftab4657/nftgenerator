...
def generate_nftsss(numberNFTs, testRarities=False, randomizedOutput=False, collection_input="", collection_output=""):
    ...
    nfts = NftCreator(numberNFTs, folderPaths, testRarities, randomizedOutput, collection_input, collection_output)
