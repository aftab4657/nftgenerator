...
# def long_task(number_listnf, testRarities=False, randomizedOutput=False, collection_input="", collection_output=""):
#Folders names that will store ur uniques nfts, u can add more!

public_nts_total = sys.argv[1]
collection_input = sys.argv[2]
collection_output = sys.argv[3]

testRarities = False
randomizedOutput = False
number_listnf = [int(public_nts_total), 0, 0]
